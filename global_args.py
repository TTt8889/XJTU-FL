...
def read_args():
    ...
    parser.add_argument('--npy_file_name', type=str,                         
                        help='output section name')
    
    parser.add_argument('--hyper_e', type=int,                         
                        help='hyper e')
    
    parser.add_argument('--softmax_seg', type=str,                         
                        help='softmax_seg')
...
def override_args(args, cli_args):
    ...
    for key, value in vars(cli_args).items():
        ...
        if value is not None:
            ...
            print(f"INFO: Overriding {key} with {value}")
...
def single_preprocess(args):
    ...
    args.output = f'./logs/{args.algorithm}/{args.dataset}_{args.model}/{args.distribution}/{args.attack}_{args.defense}/{args.epochs}_{args.num_clients}_{args.num_adv}_{args.learning_rate}_{formatted_time}.txt'
