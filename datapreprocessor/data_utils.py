...
def load_data(args):
    ...
    data_directory = "/home/ymh/wxy/FLPoison/data"
...
def split_dataset(args, train_dataset, test_dataset):
    ...
    # plot_label_distribution(train_dataset, client_indices, args.num_clients, args.dataset, args.distribution, args.dirichlet_alpha)
    return client_indices, test_dataset
